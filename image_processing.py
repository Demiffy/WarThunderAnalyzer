...
def extract_text_from_image(image):
    """Extract text using OCR after preprocessing for colors."""
...
def extract_battle_text_from_image(image):
    """Extract text from the battle region."""
    try:
        custom_config = r'--oem 3 --psm 6'
...
def extract_modules_text_from_image(image):
    """Extract text from the modules region after module-specific preprocessing."""
